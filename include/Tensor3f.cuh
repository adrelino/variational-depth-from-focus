...
namespace vdff {
  ...
  public:
    ...
    Tensor3f(Utils::InfoImgSeq imgSeqInfo, std::string name="NoName");
    ...
    //Getters
    Utils::ImgInfo getImgInfo(){Utils::ImgInfo imgInfo = { info.w , info.h , info.nc*info.nrImgs }; return imgInfo;};  //TODO: rather check that imgSeqInfo.nrImgs==1?
  ...
  private:
    ...
    Utils::InfoImgSeq info; //dont store ImgInfo, that is just a InfoImqSeq with nrImgs=1;
    size_t nrPixels;
    size_t nrBytes;
